...
local formatting = require("core.plugins.formatting.formatting")
...
local util = require("core.plugins.util.util")
local black = require("core.plugins.formatting.black")
local prettier = require("core.plugins.formatting.prettier")
...
local dot = require("core.plugins.util.dot")
local mini_hipatterns = require("core.plugins.util.mini-hipatterns")
local project = require("core.plugins.util.project")
